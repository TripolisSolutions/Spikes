module OData
  module AbstractQuery
    module Errors
      ...
      #filter exceptions
      class AbstractQueryFilterException < AbstractQueryException
        attr_reader :filter
      ...
      class InvalidFilterContext < AbstractQueryFilterException
        def to_s
          "Invalid context for the filter '#{@filter.value}'."
        end
      end
